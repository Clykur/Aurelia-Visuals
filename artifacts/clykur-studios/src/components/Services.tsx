...
const services = [
  {
    icon: <Camera className="w-7 h-7 sm:w-8 sm:h-8" />,
  ...
  {
    icon: <Film className="w-7 h-7 sm:w-8 sm:h-8" />,
...
export function Services() {
  return (
    <section id="services" className="py-16 md:py-24 bg-[#0a0a0a] relative overflow-hidden">
      ...
      <div className="container mx-auto px-5 sm:px-6 relative z-10">
        <div className="text-center mb-12 md:mb-20">
          <motion.span
            ...
            viewport={{ once: true }}
            className="text-primary text-xs sm:text-sm font-semibold tracking-[0.2em] uppercase block mb-4"
          >
            Our Expertise
          </motion.span>
          <motion.h2
            ...
            className="text-3xl sm:text-4xl md:text-5xl font-serif text-white max-w-3xl mx-auto leading-snug"
          >
            Crafting visual legacies with{" "}
            <span className="italic text-primary">uncompromising precision.</span>
          </motion.h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-12">
          {services.map((service, index) => (
            <motion.div
              ...
              className="p-6 sm:p-8 md:p-10 border border-white/5 bg-background/50 hover:border-primary/30 transition-colors group"
            >
              <div className="text-primary mb-6 group-hover:scale-110 transition-transform duration-500 origin-left">
                {service.icon}
              </div>
              <h3 className="text-xl sm:text-2xl font-serif text-white mb-3">{service.title}</h3>
